...
const WorkCardData = [
  {
    ...
    view: "https://resilient-mochi-c18e73.netlify.app",
    frosrc: "https://github.com/Aji0One/EComm-Frontend.git",
    bsrc: "https://github.com/Aji0One/EComm-Backend.git",
  },
  {
    imgsrc: Pro4,
    title: "Let's have a Chat",
    text: "An chatting apllication with socket io for real time chatting between two users. It also has Group chat with Curd operation",
